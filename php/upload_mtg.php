...
// Obtener la extensión de los archivos subidos
...
if(isset($_FILES["fileToUpload"])) {
    ...
    if (file_exists($target_file_1)) {
        echo "El archivo " . htmlspecialchars($new_filename_1) . " ya existe. No se ha subido.<br>";
    } else {
    ...
    // Verificar si se envió un segundo archivo y si la extensión no está vacía
    if(isset($_FILES["fileToUpload_2"]) && $file_extension_2 !== "") {
